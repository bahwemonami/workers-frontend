        ...
        <div class="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav class="hidden lg:flex items-center gap-8" aria-label="Navigation principale">
            <a routerLink="/" routerLinkActive="text-workers-orange" [routerLinkActiveOptions]="{exact: true}"
               class="font-medium transition-colors hover:opacity-80 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-workers-orange after:transition-all hover:after:w-full"
