      ...
      <div class="container mx-auto px-4">
        <div class="grid lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
          ...
          <div class="lg:col-span-2 space-y-6">
            <!-- Phone -->
            <div class="bg-workers-orange text-white p-6 rounded-2xl">
              <div class="mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <h3 class="text-xl font-bold mb-2">Téléphone (24/7)</h3>
              <a href="tel:+33180906600" class="text-2xl font-heading hover:underline" aria-label="Appeler le 01 80 906 600">
                01 80 906 600
              </a>
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              <div class="mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-workers-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 class="text-xl font-bold text-dark mb-2">Email</h3>
              <a href="mailto:call@workers-paris.fr" class="text-workers-orange hover:underline" aria-label="Envoyer un email à call@workers-paris.fr">
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              ...
              <h3 class="text-xl font-bold text-dark mb-2">Adresse</h3>
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              ...
              <h3 class="text-xl font-bold text-dark mb-2">SIRET</h3>
              <p class="text-gray-600">934 562 331 00017</p>
            </div>
          </div>
        </div>
      </div>
